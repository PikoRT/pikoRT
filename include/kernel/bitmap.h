...
static inline void bitmap_queue_add(struct list_head *new, unsigned long bit, struct bitmap_struct *bm)
{
    list_add_tail(new, &bm->queue[bit]);
    bitmap_set_bit(&bm->map, bit);
}

static inline void bitmap_queue_add_first(struct list_head *new, unsigned long bit, struct bitmap_struct *bm)
{
    list_add(new, &bm->queue[bit]);
    bitmap_set_bit(&bm->map, bit);
}

static inline void bitmap_enqueue(struct list_head *new, unsigned long bit, struct bitmap_struct *bm)
{
    bitmap_queue_add(new, bit, bm);
}

static inline void bitmap_enqueue_first(struct list_head *new, unsigned long bit, struct bitmap_struct *bm)
{
...
static inline int bitmap_queue_empty(struct bitmap_struct *bm, unsigned long bit)
{
...
static inline void bitmap_queue_del(struct list_head *queue, unsigned long bit, struct bitmap_struct *bm)
{
    list_del(queue);
...
static inline struct list_head *bitmap_dequeue(struct bitmap_struct *bm, unsigned long bit)
{
...
static inline struct list_head *bitmap_dequeue_tail(struct bitmap_struct *bm, unsigned long bit)
{
